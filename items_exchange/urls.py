"""URL configuration for items_exchange project.
...
# AdViewSet поддерживает создание, редактирование, удаление и поиск (фильтрацию) объявлений.
router.register(r'ads', AdViewSet, basename='ad')

# Регистрируем маршруты для работы с предложениями обмена.
